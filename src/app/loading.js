    ...
    <main className="animate-pulse py-12">
      <div className="space-y-10">
        <div className="space-y-4">
          ...
          <div className="bg-surface h-14 w-125 max-w-full rounded-xl" />

          <div className="bg-surface h-5 w-155 max-w-full rounded-lg" />

          <div className="bg-surface h-5 w-120 max-w-full rounded-lg" />
        </div>
